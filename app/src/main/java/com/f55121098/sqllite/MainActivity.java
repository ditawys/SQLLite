...
import com.f55121098.sqllite.databinding.ActivityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnLogin.setOnClickListener(view -> {
            ...
            if (res) {
                ...
                Intent contentIntent = new Intent(MainActivity.this, ContenActivity.class);
                startActivity(contentIntent);
            } else {
                Toast.makeText(MainActivity.this, "Usernamr atau Password Anda Salah", Toast.LENGTH_SHORT).show();
            }
